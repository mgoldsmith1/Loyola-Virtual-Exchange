...
public class ClientFrame extends JFrame {
    ...
    private void prepareGUI(){
        ...
        mainFrame.setLocationRelativeTo(null); // To center the GUI
     }
     ...
     class MenuItemListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {            
           ...
           if(e.getActionCommand().contains("Server...") && foo == false){ //(Executor) 
        	  ...
        	  //but this forces you to use the absolute filepath
        	  ...
        	  // correct file path
        	  /* ProcessBuilder pb = new ProcessBuilder("java", "-jar", "~/Market-Exchange-Simulator/osc-project-6/Exchange/jars/server.jar");
        	   try {
			    Process p = pb.start();
